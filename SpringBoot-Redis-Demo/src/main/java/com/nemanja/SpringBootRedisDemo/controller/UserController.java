package com.nemanja.SpringBootRedisDemo.controller;

import com.nemanja.SpringBootRedisDemo.model.User;
import com.nemanja.SpringBootRedisDemo.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<String> updateUser(@PathVariable("id") Long id, @RequestBody User user){
        boolean result = userService.upadateUser(id,user );
        if(result)
